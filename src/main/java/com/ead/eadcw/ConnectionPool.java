...
public class ConnectionPool {
    ...
    private static final String URL = "jdbc:mysql://localhost:3306/tharindu";
    private static final String USER = "tharindupy";
    private static final String PASSWORD = "tharindu";
